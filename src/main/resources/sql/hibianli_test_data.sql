...
UPDATE hibianli_device_goods SET stock_quantity = stock_quantity - 2 WHERE device_code = 'DEV001' AND goods_id = 1001;
UPDATE hibianli_device_goods SET stock_quantity = stock_quantity - 1 WHERE device_code = 'DEV001' AND goods_id = 1005;
UPDATE hibianli_device_goods SET stock_quantity = stock_quantity - 1 WHERE device_code = 'DEV001' AND goods_id = 1008;
UPDATE hibianli_device_goods SET stock_quantity = stock_quantity - 1 WHERE device_code = 'DEV002' AND goods_id = 1002;
UPDATE hibianli_device_goods SET stock_quantity = stock_quantity - 1 WHERE device_code = 'DEV002' AND goods_id = 1006;
UPDATE hibianli_device_goods SET stock_quantity = stock_quantity - 3 WHERE device_code = 'DEV003' AND goods_id = 1001;
UPDATE hibianli_device_goods SET stock_quantity = stock_quantity - 1 WHERE device_code = 'DEV003' AND goods_id = 1007;
